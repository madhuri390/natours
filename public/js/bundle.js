...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFkaHVydmVlcmFtcmVkZHkiLCJhIjoiY2tuZnh3bjBwMjVtcjJwbGN0M3QxbjMwNSJ9.1e4qyrYRU-1wn-WMwS1WgQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/madhurveeramreddy/cknh6z2ae57kq17o77khmg61l',
    scrollZoom: false // center: [-118.24286279680537, 34.059990409778926],
    // zoom: 10,
    //interactive:false
...
var stripe = Stripe('pk_test_51Ilzd4SIiZ7mNkQYVwWWTPl1ySePJPN9gc9c79abWi13YwSeRpDX3qwyYIDUyNrcnktgYHDFIHPEYPxzAe6nSHAC00a5j5pNh4');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2)Create checkout form and Charge the credit card
...
console.log(userPasswordForm); //Values
//Delegation
